import podcasts from "./flightpodcasts.js";
...
function sortByDuration(data, flightLength){
    ...
    } else data.sort((a,b)=>b.duration-a.duration)
    data.forEach(item=> console.log(`${item.title}, ${item.duration} minutes`))
}

sortByDuration(podcasts, 601);
